...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << ParseHex("02d5ff52f26ac105c272d8340acd3b828f21b665fb42281b88b613abb7407de3a7") << OP_CHECKSIG;
...
//        consensus.powLimit = uint256S("00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        ...
        // 两周期望产生的块数  1. 每产生2016个块就会判断时间时间达到两周根据时间偏差调整难度 2. ? 猜测 bip9规则执行?
...
//  PrintGenesisBlockProof(0, 0x207fffff, 1,50 * COIN, consensus.powLimit);
        ...
        // assert(consensus.hashGenesisBlock == uint256S("0xfbbf29fa0a8e9c7ae38c405b3453dcb0da2323ba9aea810c26f976ebb940619d"));
